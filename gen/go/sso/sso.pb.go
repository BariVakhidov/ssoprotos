...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` //User ID of the registererd user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x11, 0x62, 0x61, 0x72, 0x69, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73,
